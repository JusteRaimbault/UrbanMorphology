...
$\rightarrow$ Interaction between networks and territories to capture the form-function link \cite{raimbault2018caracterisation}; potential application to sustainability of urban systems
...
\textbf{Implementation: } construction of a single layer spatial network given the condition on the two layers and distances; extraction of connected components.
...
\includegraphics[height=0.85\textheight]{figures/aggreg_morpho_relemissions-relefficiency_colpc1_logscale.png}
...
\textbf{Apply to the summer school !} \texttt{https://exmodelo.org/}
...
$\rightarrow$ Transfer to policy making recommandations: Pareto-optimal configuration can be used for the planning of regional transportation networks, subsidies policies, etc.
\smallskip
...
$\rightarrow$ Extrapolation of transportation flows
...
\includegraphics[height=0.9\textheight]{figures/aggreg_effective.png}
