...
\affil[1]{CASA, UCL, UK}
\affil[2]{UPS CNRS 3611 ISC-PIF, France} 
...
% TODO - Last paragraph of 2.1.1: in my understanding the sentence “a first component for two nodes to interact is a large enough proximity” should be “a first component for two nodes to interact is a small enough proximity
% TODO Last paragraph of 2.1.2: Please do not call \Theta as percolation threshold. This is a threshold to consider large enough populations to create links. Percolation threshold in the percolation literature refers to the critical value of the control parameter (i.e. a critical r_0, \Theta pair here) at which the percolating phase-transition evolves and a giant percolating component appear in the system.
% TODO - The first one about the choice of calibration (paragraph 3.2): We make the radius vary betweem [Typo: between] 8km and 100km with a one km step, have a fixed population threshold θ P = 0.85, test all road network indicators, and three network layer thresholds θ N ∈ {0; 0.8; 0.95}. » Why is this calibration chosen? Maybe just one sentence to explain it could be interesting.
% TODO - The second about a sentence, little further in the same paragraph: « As the addition of a layer also changes drastically the results, one should stay careful when switching from a mono-dimensional percolation to a multi-dimensional percolation. » This impact sounds crucial and the choice of the multi-dimensional percolation versus a single one had not been discussed. Again, a short explanation in the introduction could be interesting.
