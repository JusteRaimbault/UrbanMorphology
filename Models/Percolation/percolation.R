...
params=matrix(0,length(quantiles)^2*length(radiuses)*length(nwindics),4)
i=1
...
params$nwthq=as.numeric(params$nwthq);params$popthq=as.numeric(params$popthq);params$radius=as.numeric(params$radius)
